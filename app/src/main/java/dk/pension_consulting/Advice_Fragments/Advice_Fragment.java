...
public class Advice_Fragment extends android.support.v4.app.Fragment {
    ...
    private ArrayList<String> list = new ArrayList<String>() {{
        add("Start tidligt\n" +
                "\n" +
                "Det er en god ide at starte så tidligt som muligt med pensionsopsparingen. Med renters rente gør det en stor forskel for din opsparing som pensionist, hvis du har sparet op i 25 eller 35 år.\n" +
                "\n" +
        ...
        add("Læg ikke alle dine æg i én kurv\n" +
                "\n" +
                "Det er meget fornuftigt ikke kun at spare op på sin pensionsordning, men også at have andre former for opsparing som f.eks. fast ejendom. Betal derfor gerne lidt mindre ind på pensionsordningen og investér i stedet nogle penge på andre måder.");
        add("Forsikringerne er vigtige\n" +
                "\n" +
                "En pensionsordning indeholder i de fleste tilfælde forsikringer, som dækker dig og dine efterladte i tilfælde af sygdom og død. Det er meget vigtigt, at disse forsikringer altid er opdateret, så de svarer til dine behov.\n" +
                "\n" +
        ...
        add("Hvis du har gæld\n" +
                "\n" +
                "Om du skal indfri lån i stedet for at spare mere op til pension afhænger af, hvor dyre lånene er. Jo dyrere lån, jo mere sandsynligt er det, at det bedre kan svare sig for dig at indfri lånet.\n" +
                "\n" +
        ...
        add("Du bør samle dine pensioner\n" +
                "\n" +
                "Der er omkostninger forbundet med hver eneste pensionsordning, du har. Du kan derfor spare mange penge ved at samle dine pensioner.\n" +
                "\n" +
        ...
        add("Indbetal ekstra via din arbejdsgiver\n" +
                "\n" +
                "Ønsker du at indbetale ekstra til din pensionsopsparing, kan du næsten altid få bedre vilkår, hvis du har mulighed for at gøre det via en evt. arbejdsgiver. Arbejdsgiverne har næsten altid forhandlet sig frem til bedre vilkår, end du selv kan opnå som privatperson.\n" +
                "\n" +
        ...
        add("Er du specialist i investeringer?\n" +
                "\n" +
                "Langt de fleste har ikke nogen særlig forstand på investering af deres pensionsopsparing. Er du som de fleste, bør du overlade investeringerne til eksperterne i dit pensionsselskab.\n" +
                "\n" +
        ...
        add("Begunstigelse\n" +
                "\n" +
                "De(n) begunstigede er de(n), som modtager udbetalingerne fra din pensionsordning i tilfælde af, at du dør. Er der flere begunstigede, deler de som udgangspunkt lige, men du kan også bestemme, hvordan fordelingen skal være mellem de begunstigede.\n" +
                "\n" +
        ...
        add("Hvor meget bør jeg indbetale?\n" +
                "\n" +
                "Mange får indbetalt 10-15% til pension af deres løn, hvoraf arbejdsgiveren som regel betaler 2/3. Dette er et fornuftigt niveau, men du bør alligevel overveje at supplere med en ekstra frivillig indbetaling.\n" +
                "\n" +
        ...
        add("Søg uvildig rådgivning\n" +
                "\n" +
                "Det er vigtigt, at du søger rådgivning vedrørende dine forsikringsdækninger, investeringsvalg, samling af dine pensioner, begunstigelse, mv.\n" +
                "\n" +
    ...
    public View onCreateView (LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstance) {
        ...
        Advice_Adapter adapter = new Advice_Adapter(this.getActivity(), R.layout.single_item_advice, list);
